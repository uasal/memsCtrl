...
def run_DM(shmim_name='dm02disp', vmax=180.0, nbits=16):
    '''
    ...
    try:
        while True:
            ...
            cmd2d_clipped = np.clip(cm2d_dac , 0, 2**nbits - 1)
...
def console_run_DM():
    ...
    parser.add_argument('--shmim', '-s', type=str, default='dm02disp', help='Shared memory image to watch for commands. Default: dm01disp')
